...
ISV_UNITS = [
    "Juta Rupiah", "Indeks (0–100)", "Persen (%)", "Persen (%)",
    "Indeks (0–1)", "Persen (%)", "Indeks (skala 1–5)", "Indeks (0–1)",
    "Persen (%)", "Indeks / Poin (0–100)",
]

IUP_UNITS = [
    "Tahun", "Per 100.000 kelahiran hidup", "Persen (%)", "Persen (%)",
    "Persen (%)", "Persen (%)", "Persen (%)", None, None, "Tahun", "Tahun",
    "Persen (%)", "Persen (%)", "Persen (%)", "Persen (%)", "Persen (%)",
    "Persen (%)", "Persen (%)", "Persen (%)", "Persen (%)", "Ribu Orang",
    "Rupiah", "Persen (%)", "Persen (%)", "Persen (%)", "Persen (%)",
    "Persen (%)", "Persen (%)", "Persen (%)", "Persen (%)", "Indeks (0–100)",
    "Indeks (0–100)", "Persen (%)", "Indeks (0–10)", "Persen (%)",
    "Persen terhadap PDRB (%)", "Persen terhadap PDRB (%)", "Persen (%)",
    "Persen (%)", "Indeks / Nilai (0–100)", "Indeks (0–5)", "Indeks (0–5)",
    "Indeks (0–100)", "Persen (%)", "Persen (%)", "Persen (%)",
    "Indeks (0–100)", "Persen (%)", "Persen (%) y-on-y", "Persen (%)",
    "Persen (%)", "Rupiah", "Persen (%)", "Persen (%)", "Kerja sama (dokumen)",
    "Indeks (1–5)", "Indeks (0–100)", "Indeks (0–100)", "Indeks (0–100)",
    "Indeks (0–1)", "Indeks (0–1)", "Indeks / Poin (0–100)",
    "Indeks / Poin (0–100)", "Indeks / Poin (0–100)",
    "Indeks / Poin (0–100)", "Persen (%)", "Persen (%)", "Persen RT (%)",
    "kWh/kapita/tahun", "SBM per Rp Milyar", "Persen (%)", "m³/detik",
    "Persen (%)", "Indeks / Skor (0–300)", "Persen (%)", "Persen (%)",
]

IUP_IDS = [
    *range(1, 43), 44, 45, 46, 47, 48, 49, 50, 52, 53, 54, 55, 56, 57,
